                        ...
                        <tbody style="cursor:pointer;">
                            ...
                            foreach ($buku as $b) { ?>
                                <tr>
                                    ...
                                    <td onclick="detail('<?= $b->id_buku ?>')"><img style="border-radius: 5px;" src="assets/upload/buku/<?= $b->foto ?>" alt="" width="75px"></td>
                                    ...
                                    <td>
                                        <center>
                                            <a href="<?= base_url() ?>buku/ubah/<?= $b->id_buku ?>" class="btn btn-circle btn-success btn-sm">
                                                <i class="fas fa-pen"></i>
                                            </a>
                                            <a href="#" onclick="konfirmasi('<?= $b->id_buku ?>')" class="btn btn-circle btn-danger btn-sm">
